...
action="?do=kitchencount&print=now" method="post"><table width="100%" border="0" cellpadding="0"
cellspacing="0">
...
<td class="ll"><div style="font-size:13px;padding:0 25px; float:right; width:200px;color:#BBBBBB;">Let's print off the kitchen 
count report.<br />&nbsp;</div></td>
...
</div></div><div class="snd"><input type="submit" value="Make Kitchen Count Sheets &raquo;" /></div>
</th></tr><tr>
