...
<?php
			...
			$query .= " VALUES ('" . convertFrench($_POST['f_name']) . "','" . 
				convertFrench($_POST['m_name']) . "','" . 
				convertFrench($_POST['l_name']) . "','" . 
				mysql_real_escape_string($_POST['add1']) . "','" .  
				mysql_real_escape_string($_POST['add2']) . "','" .
				mysql_real_escape_string($_POST['city']) . "','" . 
				mysql_real_escape_string($_POST['prov']) . "','" . 
				mysql_real_escape_string(strtoupper($_POST['post'])) . "','";
...
Next, let's enter information that may be useful when contacting the client.
<?php } ?>
...
<form name="mowcreate" action="?do=new&cc=3" method="post">
	<div class="gtle">What is the client's first language?</div>
	<div class="cntr4">
	...
	<div class="gtle">What language should be used for correspondance?</div>
	<div class="cntr4">
		<select style="width:100px;margin-right:2px" name="clang">
			<option value="EN">English</option>
			<option value="FR" >French</option>
			<option value="EF" >Either</option>
		</select>
	</div>
	<div class="gtle">What is the client's gender?</div
		><div class="cntr4">
		...
		<div class="gtle">When is the client's birthday?</div>
		<div class="cntr4">
			...
			year: <input class="i3" type="text" name="bdayy" maxlength="4" size="4" />
		</div>
		<div class="gtle">Is there anything that could hinder correspondance?</div>
		<div style="padding:4px 0 9px 120px;">
			<div style="text-align:left;">
				<input	type="checkbox" name="cdiff1" value="1">Expressive Difficulty<br/>
				<input type="checkbox" name="cdiff2" value="1">Hard of Hearing</div>
		</div>
	</div>
	<div class="snd">
