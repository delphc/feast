	...
	<form name="mowcreate" action="?do=new&cc=2" method="post" onSubmit="chkValue('slectNew')">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr id="sr">
				...
				<td>
					<div style="font-size:13px;padding:0 25px; float:right; width:210px;color:#BBBBBB;"><?php if ($hits < 1) {
				...
				<th class="gd" rowspan="2" colspan="2">
					<div id="nf"><div class="gtle">
						...
						<td class="gr"><img src="theme/default/p1/arw.gif" width="7" height="15" border="0" alt="" /></td>
						<th class="gd" rowspan="2" colspan="2">
							<div id="nf"><div class="gtle">Do you mean one of these people?<div 
										style="width:260px;float:right;clear:both;"><?php echo $output; ?></div></div>

								<div style="height:220px"><div style="display:none" id="cnewhide">
										<table class="inpt">
											...
											<tr>
												<td class="rt">name:</td><td><input class="i9" type="text" name="f_name" value="<?php echo $_POST['fname']; ?>" maxlength="20" size="10" /><input class="i13" type="text" name="m_name" maxlength="20" size="10" style="margin:0 2px" /><input class="i13" type="text" name="l_name" id="Lname" maxlength="20" size="10" value="<?php echo $_POST['lname']; ?>" /></td></tr>

											<tr>
												<td class="rt" rowspan="2">address:</td><td><input class="i25" type="text" name="add1" maxlength="35" size="35" 
													/></td></tr>
											<tr>
												<td><input class="i25" type="text" name="add2" maxlength="35" size="35" />
											</td></tr>
											<tr>
												<td class="rt">city:</td><td><input class="i13" type="text" name="city" maxlength="25" size="25"
													/>&nbsp;province/state: <input class="i2" type="text" name="prov" maxlength="2" size="2" value="QC" />&nbsp; postal code: <input
													class="i5" type="text" name="post" maxlength="7" size="7" style="text-transform: uppercase;" /></td></tr>
											<tr>
												<td 
													class="rt">email:</td>
												<td><input class="i25" type="text" name="email" maxlength="45" size="10" /></td></tr>
											<tr>
												<td class="rt">home&nbsp;phone:</td><td><input
						...
						</div></div><?php if (!($hits < 1)) { ?></div>
						<div class="snd" style="clear:both;"><input id="subB" type="submit" value="Continue &raquo;" disabled="true" /></div><?php
						} else { ?>
															...
															<th class="gd" rowspan="2" colspan="2">
																<div id="nf"><div class="gtle">Continue to the existing client profile 
																	...
																	<div 
																		...
																		&nbsp;</div></div></div>
															<div class="snd"><input type="submit" value="Continue &raquo;" /></div><?php
															}
																	...
																	<table width="100%" border="0" cellpadding="0"
																		...
																		<tr id="sr">
																			...
																			<th class="gd" rowspan="2" colspan="2">
																				...
																				<div class="snd" style="clear:both;"><input type="hidden" name="pass_mid" value="<?php echo $pass_mid; ?>"><input type="submit" value="Continue &raquo;" /></div><?php
																				} elseif ($cprg == 4) {
																				//keep passing along our member's ID number
																				$pass_mid = $_POST['pass_mid'];
																					...
																					<form name="mowcreate" action="?do=new&cc=5" method="post">
																						<table width="100%" border="0" cellpadding="0"cellspacing="0">
																							...
																							<tr id="sr">
																								...
																								<td>
																									<div style="font-size:13px;padding:0 25px; float:right; width:200px;color:#BBBBBB;">Alright. Next, we'll setup meal
																										delivery.<br />&nbsp;</div></td>

																								<td class="gr"><img src="theme/default/p1/arw.gif" width="7" height="15" border="0" alt="" /></td>
																								<th class="gd" rowspan="2" colspan="2">
																									<div id="nf"><div class="gtle">Will the client have meals delivered on schedule? <span 
																												style="font-size:10px">(Ongoing Delivery)</span></div>
																										<div class="cntr4">
																										...
																										<div id="rDays"><div class="gtle">On what days should the client receive meals?</div><div style="padding:0 0 10px 50px;">
																										...
																										<div class="gtle">When should the client start receiving meals?</div><div class="cntr4">
																									...
																									<div class="snd"><input type="hidden" name="pass_mid" value="<?php echo $pass_mid; ?>"><input type="submit" value="Continue &raquo;" /></div><?php
																									} elseif ($cprg == 5) {
																																				...
																																				<form name="mowcreate" action="?do=new&cc=8" method="post">
																																					<table width="100%" border="0" cellpadding="0" 
																																						...
																																						<tr id="sr">
																																							...
																																							<td class="ll">
																																								<div style="font-size:13px;padding:0 25px; float:right; width:340px;color:#BBBBBB;">Next, we'll enter meal restrictions 
																																									and preferences.<br />&nbsp;</div></td>

																																							<td class="gr"><img src="theme/default/p1/arw.gif" width="7" height="15" border="0" alt="" /></td>
																																							<th class="gd" rowspan="2" colspan="2">
																																								<div id="nf"><div class="gtle">What size of meal will the client normally want?</div>

																																									<div style="padding:0 0 0 85px;"><div style="width:120px;float:left;">
																																											<input type="radio" name="dportion" value="H" />half<br />
																																											<input type="radio" name="dportion" value="R" checked="checked" />regular</div>
																																									...
																																									<div class="gtle" style="clear:both;">What special restrictions does the client have?</div><div 
																																									...
																																									<div class="gtle" style="clear:both;">Does the client have any restrictions not categorized above?</div><div
																																																																				...
																																																																				<form>
																																																																					<table width="100%"
																																																																						...
																																																																						<tr id="sr">
																																																																							...
																																																																							<div class="snd"><input type="button" onClick="window.open('?do=show&mid=<?php echo $pass_mid; ?>', '_self', ''); return false; " value="Go &raquo;"></div><?php
