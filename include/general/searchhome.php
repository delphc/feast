<?php include "gtop1.php"; ?></div><br /><br />
...
&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="vol" value="1" checked="checked" id="chkvol" />&nbsp;&nbsp;<label for="chkvol">Volunteers</label>
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="checkbox" name="client" value="1" checked="checked" id="chkclient" />&nbsp;&nbsp;<label for="chkclient">Client</label>
...
<td id="sf"><div style="width:248px;height:18px;"><input type="text" id="mq_sr" name="mquery" size="10" /></div>
...
<div id="cn" class="w8"><div id="ca"><img src="p1/aplo.gif" width="164" height="66" border="0" alt="" /></div>
<div id"ct"><table width="100%" border="0" cellpadding="0" cellspacing="0" style="clear:left">
<tr>
<td id="bp">&nbsp;</td>
<td id="cp">&nbsp;</td></tr></table><br />
